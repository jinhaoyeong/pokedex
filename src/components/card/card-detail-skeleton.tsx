  ...
  return (
    ...
    >
      <div className="flex items-center gap-3 text-sm font-bold text-slate-400">
        ...
        <span>/</span>
        <span className="h-9 w-40 max-w-[55vw] animate-pulse rounded-xl bg-white/10" />
      </div>
      ...
      <section className="glass-card min-h-[30rem] animate-pulse rounded-3xl border-white/10 p-4 sm:min-h-[34rem] sm:p-6" />

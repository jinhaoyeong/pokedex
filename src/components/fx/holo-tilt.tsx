...
/**
 * Wraps card artwork in a pointer-reactive holographic surface: a 3D tilt that
 * follows the cursor plus a foil shimmer and moving glare. Falls back to a flat
 * (but still styled) surface on touch devices and when reduced motion is set.
 */

...
export const CORE_SOURCE_BUDGET_MS = PRICECHARTING_HTML_BUDGET_MS;
...
export const LOCALIZED_CORE_GRADING_BUDGET_MS = CORE_SOURCE_BUDGET_MS + 2_000;
export const ENGLISH_CORE_GRADING_BUDGET_MS = CORE_SOURCE_BUDGET_MS + 2_000;
export const FULL_GRADING_BUDGET_MS = FULL_SOURCE_BUDGET_MS + 6_000;

/** Browser abort must outlive the serverless gather so Magery is not cancelled first. */
export const LIVE_MARKET_CLIENT_TIMEOUT_MS = FULL_GRADING_BUDGET_MS + 4_000;

...
const RANK_TIERS: Array<{ title: string; icon: string; floor: number; blurb: string }> = [
  { title: "Youngster", icon: "🧢", floor: 0, blurb: "Every Champion starts with a single card." },
  { title: "Bug Catcher", icon: "🐛", floor: 50, blurb: "The collection is catching momentum." },
  { title: "Ace Trainer", icon: "⚡", floor: 250, blurb: "A sharp, well-rounded binder." },
  { title: "Gym Leader", icon: "🏅", floor: 1000, blurb: "Serious holdings — badge earned." },
  { title: "Elite Four", icon: "👑", floor: 5000, blurb: "Elite-tier vault. Few make it here." },
  { title: "Champion", icon: "🏆", floor: 20000, blurb: "You are the Champion. Hall of Fame stuff." },
];

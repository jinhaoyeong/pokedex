...
function isOfficialJapaneseCatalogFallbackCard(card: TcgCard) {
  if (card.language !== "ja") {
    return false;
  }
...
function stripOfficialJapaneseCatalogFallbackPrice(card: TcgCard): TcgCard {
  if (!isOfficialJapaneseCatalogFallbackCard(card)) {
    return card;
  }
